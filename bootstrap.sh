...
NIX_PATH="darwin-config=$HOME/Projects/dots:$HOME/.nixpkgs/darwin-configuration.nix:/nix/var/nix/profiles/per-user/jensnavne/channels:$NIX_PATH" darwin-rebuild switch || exit 1
